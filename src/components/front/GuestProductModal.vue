...
const { dataProduct } = storeToRefs(productStore);
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-footer gap-1 gap-sm-3 bg-middle">
          ...
          :disabled="dataProduct.id === isLoading  || qty < 1"
          :class="{buttonDisabledCursor : dataProduct.id === isLoading || qty < 1}">
            <span  class="spinner-border spinner-border-sm"  role="status" aria-hidden="true"
            v-show="dataProduct.id === isLoading"></span>
            加入購物車
          </button>
